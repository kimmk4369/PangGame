...
# 화면 타이틀 설정
pygame.display.set_caption("팡 게임")
...
image_path = os.path.join(current_path, "images")  # images 폴더의 위치 반환
...
# 게임 종료 메시지 / Timeout, Mission Compleate, Game Over
...
while running:
    ...
    for ball_idx, ball_val in enumerate(balls):
        ...
        break # 안쪽 for 문에서 break를 만나면 여기로 진입 가능    
